...
const Gallery = ({ images, providerName }) => {
  ...
  return (
    <>
      {/* Grid Layout */}
      <div
        className="grid grid-cols-1 md:grid-cols-4 gap-1 md:gap-2 h-[30vh] md:h-[50vh] cursor-pointer relative">
        {/* Main Large Image */}
        <div
      ...
      {showModal && (
        ...
        >
          {/* Modal Header */}
          <div
            className="fixed top-0 left-0 right-0 bg-black bg-opacity-50 p-4 flex justify-between items-center">
