...
const Option: React.FC<ProviderOptionProps> = ({ provider, label }) => {
  ...
  return (
    <div className="flex items-center gap-4 group w-full overflow-hidden">
      <div
        className="rounded overflow-hidden bg-gray-100 dark:bg-gray-800 flex items-center justify-center shrink-0">
        <Image
      ...
      <div className="flex flex-col">
        <span
          className="font-semibold text-gray-900 dark:text-gray-100 group-hover:text-primary transition-colors text-lg/5 tracking-tight">{label}</span>
